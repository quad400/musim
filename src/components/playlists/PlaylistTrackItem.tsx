...
import MenuContentPlaylistTrackItem from "../MenuContentPlaylistTractItem";
  ...
  return (
    ...
    >
      <View style={styles.wrapper}>
        ...
        >
          {activeTrack?.preview === item.url && playing && (
            <LoaderKit
      ...
      <StopPropagation>
        <MenuContentPlaylistTrackItem item={item} />
      </StopPropagation>
    </TouchableOpacity>
  );
};
